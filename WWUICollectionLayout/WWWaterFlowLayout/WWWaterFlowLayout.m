...
#import "WWWaterFlowLayout.h"

/** 默认的列数*/
static const NSInteger WWDefaultColumeCount = 2;
/** 默认的行数*/
static const NSInteger WWDefaultRowCount = 5;

/** 每一列之间的间距*/
static const NSInteger WWDefaultColumeMargin = 10;
/** 每一行之间的间距*/
static const CGFloat WWDefaultRowMargin = 10;
/** 边缘之间的间距*/
static const UIEdgeInsets WWDefaultEdgeInset = {10, 10, 10, 10};

///** 每一行之间的间距*/
//static const CGSize WWDefaultHeaderSize = CGSizeMake(0, 66);
///** 每一行之间的间距*/
//static const CGSize WWDefaultFooterSize = CGSizeMake(0, 66);


@interface WWWaterFlowLayout ()
...
@implementation WWWaterFlowLayout
...
-(void)prepareLayout {
    ...
    if (self.flowLayoutStyle == WWWaterFlowVerticalEqualWidth) {
    ...
    }else if (self.flowLayoutStyle == WWWaterFlowHorizontalEqualHeight){
    ...
    }else if (self.flowLayoutStyle == WWWaterFlowVerticalEqualHeight){
